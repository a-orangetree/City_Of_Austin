...
ridge_model <- glmnet(crimes_2016 ~ . -crimes_2015
                      #venues + Non_White_Non_Hispanic + Hispanic + Passive_Park + MultiFamily
                      , data = train_data
                      , alpha = 0)

ridge_cv <- cv.glmnet(crimes_2016 ~ . -crimes_2015
                      #venues + Non_White_Non_Hispanic + Hispanic + Passive_Park + MultiFamily
                      , data = train_data
                      , alpha = 0)
...
sqrt(mean(ridge_predictions$diff_sq))


####### Lasso################


lasso_model <- glmnet(crimes_2016 ~ . -crimes_2015
                      # venues + Non_White_Non_Hispanic + Hispanic + Passive_Park + MultiFamily
                      , data = train_data
                      , alpha = 1)

lasso_cv <- cv.glmnet(crimes_2016 ~ . -crimes_2015
                      # venues + Non_White_Non_Hispanic + Hispanic + Passive_Park + MultiFamily
                      , data = train_data
                      , alpha = 1)
...
sqrt(mean(lasso_predictions$diff_sq))
...
sqrt(mean(testing_data_boost$diff_sq))
